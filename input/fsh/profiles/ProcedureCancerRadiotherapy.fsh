...
* category = $cancer-cs#cancr0025.00004 "Independent radical"

* code = $cancer-cs#cancr0026.00001 "Remote"

* extension[radiotherapyZone].valueCodeableConcept =
    $cancer-cs#cancr0027.00001 "Primary focus"

* extension[radiotherapyModifiers][0].valueCodeableConcept =
    $cancer-cs#cancr0028.00002 "Radiosensitizers"
...
* bodySite = $cancer-cs#cancr0007.00003 "Liver"
...
* used = $cancer-cs#cancr0029.00002 "Actinomycin"
