...
* code = $cancer-cs#cancr0011.00008 "cT category"
...
* performer = Reference(practitionerrole-001)
...
* status = #final
* category = $observation-category#imaging "Imaging"
* code = $cancer-cs#cancr0011.00007 "cN category"
* subject = Reference(example-patient-john)
* focus = Reference(condition-cancer-primary-example)
* effectiveDateTime = "2026-02-10"
* performer = Reference(practitionerrole-001)
...
* status = #final
* category = $observation-category#imaging "Imaging"
* code = $cancer-cs#cancr0011.00006 "cM category"
...
* status = #final
* category = $observation-category#imaging "Imaging"
* code = $cancer-cs#cancr0011.00012 "pT category"
...
* status = #final
* category = $observation-category#imaging "Imaging"
* code = $cancer-cs#cancr0011.00011 "pN category"
...
* status = #final
* category = $observation-category#imaging "Imaging"
* code = $cancer-cs#cancr0011.00010 "pM category"
