Instance: sr-lab-research-to-loinc
InstanceOf: ConceptMap
Usage: #definition
Title: "Service Request Research codes to LOINC"
Description: "Uzbekistan national code system for laboratory test orders mapped to LOINC codes. This CodeSystem contains codes for laboratory tests that can be requested via ServiceRequest resource"
* url = "https://terminology.dhp.uz/fhir/core/ConceptMap/sr-lab-research-to-loinc"
* name = "SRLlabRearchToLoinc"
* status = #draft
* experimental = false
* publisher = "Uzinfocom"

* group.source = Canonical(SRLabResearchCS)
* sourceScopeCanonical = Canonical(SRLabResearchVS)
* group.target = $service-request-lab-research-codes-cs
* targetScopeCanonical = $sr-lab-research-vs
