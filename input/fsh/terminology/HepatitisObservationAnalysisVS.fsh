...
* ^url = "https://terminology.dhp.uz/ValueSet/hep-observation-analysis-vs"
* ^experimental = true

* $loinc#22314-9 "Gepatit A virusiga qarshi antitanalar — anti-HAV1234"
...
* $loinc#29610-3 "Gepatit B virusi DNKsi — sifat jihatidan"
  * ^designation[0].language = #ru
...
* $loinc#42595-9 "Gepatit B virusi DNKsi — miqdoriy (IU/mL)"
  * ^designation[0].language = #ru
...
* $loinc#75410-1 "Gepatit B virusi yuzaki antigeni (HBsAg) [Borligi]: Sarum, plazma yoki qonda ekspress-immunoxromatografik tahlil (immunoesse) usuli bilan."
  * ^designation[0].language = #ru
  ...
  * ^designation[+].language = #en
  * ^designation[=].value = "Hepatitis B virus surface Ag [Presence] in Serum, Plasma or blood by Rapid immunoassay"

* $loinc#22322-2 "Gepatit B virusining yuzaki antigeniga qarshi antitanalar — anti-HBs"
  * ^designation[0].language = #ru
...
* $loinc#5195-3 "Gepatit B virusining yuzaki antigeni — HBsAg"
  * ^designation[0].language = #ru
...
* $loinc#13952-7 "Gepatit B virusining yadroviy antigeniga qarshi antitanalar — anti-HBc"
  * ^designation[0].language = #ru
...
* $loinc#13954-3 "Gepatit B virusining e-antigeni — HBeAg"
  * ^designation[0].language = #ru
...
* $loinc#22320-6 "Gepatit B virusining e-antigeniga qarshi antitanalar — anti-HBe"
  * ^designation[0].language = #ru
...
* $loinc#11259-9 "Gepatit C virusi RNKsi — sifat jihatidan"
  * ^designation[0].language = #ru
...
* $loinc#11011-4 "Gepatit C virusi RNKsi — miqdoriy (IU/mL)"
  * ^designation[0].language = #ru
...
* $loinc#32286-7 "Gepatit C virusi genotipi — genotiplash"
  * ^designation[0].language = #ru
...
* $loinc#22327-1 "Gepatit C virusiga qarshi antitanalar — miqdoriy"
  * ^designation[0].language = #ru
...
* $loinc#13955-0 "Gepatit C virusiga qarshi antitanalar — umumiy (Anti-HCV)"
  * ^designation[0].language = #ru
...
* $loinc#7906-1 "Gepatit D virusi RNKsi — sifat jihatidan"
  * ^designation[0].language = #ru
...
* $loinc#85512-2 "Gepatit D virusi RNKsi — miqdoriy (IU/mL)"
  * ^designation[0].language = #ru
