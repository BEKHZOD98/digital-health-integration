CodeSystem: CodeSystemICCC3
Id: codesystem-iccc-3
Title: "Cancer ICCC3 code system"
Description: "A coding system based on the International Classification of Childhood Cancer, 3rd edition (ICCC-3). This system is used to classify cancers occurring in children."

* ^url = "https://terminology.dhp.uz/CodeSystem/codesystem-iccc-3"
...
* #I.a.2 "Old hujayralardan rivojlangan leykozlar"
  * ^designation[0].language = #ru
...
* #I.a.3 "Yetuk B-hujayrali leykozlar"
  * ^designation[0].language = #ru
...
* #I.a.4 "Limfoid leykoz, aniqlanmagan"
  * ^designation[0].language = #ru
...
* #I.c "Surunkali miyeloproliferativ kasalliklar"
  * ^designation[0].language = #ru
...
* #I.d "Miyelodisplastik sindrom va boshqa miyeloproliferativ kasalliklar"
  * ^designation[0].language = #ru
...
* #I.e "Aniqlanmagan va boshqa aniqlangan leykozlar"
  * ^designation[0].language = #ru
...
* #II.b "Non-Xodjkin limfomalari (Berkitt limfomasidan tashqari)"
  * ^designation[0].language = #ru
...
* #II.b.1 "Old hujayralardan rivojlangan limfomalar"
  * ^designation[0].language = #ru
...
* #II.b.2 "Yetuk B-hujayrali limfomalar (Berkitt limfomasidan tashqari)"
  * ^designation[0].language = #ru
...
* #II.b.3 "Yetuk T-hujayra va NK-hujayra limfomalari"
  * ^designation[0].language = #ru
...
* #II.b.4 "Non-Xodjkin limfomalari, aniqlanmagan"
  * ^designation[0].language = #ru
...
* #II.d "Boshqa limforetikulyar o‘smalar"
  * ^designation[0].language = #ru
...
* #III.a.2 "Tomirli pleksus o‘smalari"
  * ^designation[0].language = #ru
...
* #III.с "Intrakranial va intraspinal embrional o‘smalar"
  * ^designation[0].language = #ru
...
* #III.c.2 "Primitiv neyroektodermal o‘sma (PNET)"
  * ^designation[0].language = #ru
...
* #III.c.4 "Atipik teratoid/rabdoid o‘sma"
  * ^designation[0].language = #ru
...
* #III.d.2 "Aralash va aniqlanmagan gliomalar"
  * ^designation[0].language = #ru
...
* #III.d.3 "Kelib chiqishi noaniq neyroepitelial glial o‘smalar"
  * ^designation[0].language = #ru
...
* #III.e "Boshqa aniqlangan intrakranial va intraspinal o‘smalar"
  * ^designation[0].language = #ru
...
* #III.e.1 "Gipofiz adenomasi va karsinomasi"
  * ^designation[0].language = #ru
...
* #III.e.2 "Sellar soha o‘smalari (kraniofaringiomalar)"
  * ^designation[0].language = #ru
...
* #III.e.3 "Pineal parenxima o‘smalari"
  * ^designation[0].language = #ru
...
* #III.e.4 "Neyronal va aralash neyronal-glial o‘smalar"
  * ^designation[0].language = #ru
...
* #III.f "Aniqlanmagan intrakranial va intraspinal o‘smalar"
  * ^designation[0].language = #ru
...
* #IV.a "Neyroblastoma va ganglionevroblastoma"
  * ^designation[0].language = #ru
...
* #IV.b "Boshqa periferik nerv hujayralari o‘smalari"
  * ^designation[0].language = #ru
...
* #VI.a "Nefroblastoma va boshqa epitelial bo‘lmagan buyrak o‘smalari"
  * ^designation[0].language = #ru
...
* #VI.a.2 "Buyrakning rabdoid o‘smasi"
  * ^designation[0].language = #ru
...
* #VI.c "Aniqlanmagan yomon sifatli buyrak o‘smalari"
  * ^designation[0].language = #ru
...
* #VII.c "Aniqlanmagan yomon sifatli jigar o‘smalari"
  * ^designation[0].language = #ru
...
* #VIII.c "Ewing o‘smasi va unga o‘xshash suyak sarkomalari"
  * ^designation[0].language = #ru
...
* #VIII.c.1 "Ewing va Askin suyak o‘smalari"
  * ^designation[0].language = #ru
...
* #VIII.d "Boshqa aniqlangan yomon sifatli suyak o‘smalari"
  * ^designation[0].language = #ru
...
* #VIII.d.1 "Suyaklarning yomon sifatli fibroz o‘smalari"
  * ^designation[0].language = #ru
...
* #VIII.d.2 "Yomon sifatli xordomalar"
  * ^designation[0].language = #ru
...
* #VIII.d.3 "Odontogen yomon sifatli o‘smalar"
  * ^designation[0].language = #ru
...
* #VIII.d.4 "Boshqa yomon sifatli suyak o‘smalari"
  * ^designation[0].language = #ru
...
* #VIII.e "Aniqlanmagan yomon sifatli suyak o‘smalari"
  * ^designation[0].language = #ru
...
* #IX.b "Fibrosarkomalar, periferik nerv qobig‘i o‘smalari va boshqa fibroz o‘smalar"
  * ^designation[0].language = #ru
...
* #IX.b.1 "Fibroblastik va miofibroblastik o‘smalar"
  * ^designation[0].language = #ru
...
* #IX.b.3 "Boshqa fibromatoz o‘smalar"
  * ^designation[0].language = #ru
...
* #IX.d "Boshqa aniqlangan yumshoq to‘qima sarkomalari"
  * ^designation[0].language = #ru
...
* #IX.d.1 "Yumshoq to‘qimalarning Ewing va Askin o‘smalari"
  * ^designation[0].language = #ru
...
* #IX.d.3 "Ekstrarenal rabdoid o‘sma"
  * ^designation[0].language = #ru
...
* #IX.d.5 "Fibrogistiotsitar o‘smalar"
  * ^designation[0].language = #ru
...
* #IX.d.9 "Yumshoq to‘qimaning suyak va tog‘ay o‘smalari"
  * ^designation[0].language = #ru
...
* #IX.d.10 "Alveolyar yumshoq to‘qima sarkomasi"
  * ^designation[0].language = #ru
...
* #IX.d.11 "Boshqa yumshoq to‘qima sarkomalari"
  * ^designation[0].language = #ru
...
* #IX.e "Aniqlanmagan yumshoq to‘qima sarkomalari"
  * ^designation[0].language = #ru
...
* #X.a "Intrakranial va intraspinal jinsiy hujayra o‘smalari"
  * ^designation[0].language = #ru
...
* #X.a.1 "Intrakranial va intraspinal germinomalar"
  * ^designation[0].language = #ru
...
* #X.a.2 "Intrakranial va intraspinal teratomalar"
  * ^designation[0].language = #ru
...
* #X.a.3 "Intrakranial va intraspinal embrional karsinomalar"
  * ^designation[0].language = #ru
...
* #X.a.4 "Intrakranial va intraspinal sariq xalta o‘smalari"
  * ^designation[0].language = #ru
...
* #X.a.5 "Intrakranial va intraspinal xoriokarsinoma"
  * ^designation[0].language = #ru
...
* #X.a.6 "Intrakranial va intraspinal aralash turdagi o‘smalar"
  * ^designation[0].language = #ru
...
* #X.b "Ekstrakranial va ekstragonadal yomon sifatli jinsiy hujayra o‘smalari"
  * ^designation[0].language = #ru
...
* #X.b.1 "Ekstrakranial va ekstragonadal joylashuvdagi yomon sifatli germinomalar"
  * ^designation[0].language = #ru
...
* #X.b.2 "Ekstrakranial va ekstragonadal joylashuvdagi yomon sifatli teratomalar"
  * ^designation[0].language = #ru
...
* #X.b.3 "Ekstrakranial va ekstragonadal embrional karsinomalar"
  * ^designation[0].language = #ru
...
* #X.b.4 "Ekstrakranial va ekstragonadal sariq xalta o‘smalari"
  * ^designation[0].language = #ru
...
* #X.b.5 "Ekstrakranial va ekstragonadal xoriokarsinomalar"
  * ^designation[0].language = #ru
...
* #X.b.6 "Ekstrakranial va ekstragonadal boshqa va aniqlanmagan aralash jinsiy hujayra o‘smalari"
  * ^designation[0].language = #ru
...
* #X.c "Gonadal yomon sifatli jinsiy hujayra o‘smalari"
  * ^designation[0].language = #ru
...
* #X.c.1 "Gonadal yomon sifatli germinomalar"
  * ^designation[0].language = #ru
...
* #X.c.2 "Gonadal yomon sifatli teratomalar"
  * ^designation[0].language = #ru
...
* #X.c.3 "Gonadal embrional karsinomalar"
  * ^designation[0].language = #ru
...
* #X.c.4 "Gonadal sariq xalta o‘smalari"
  * ^designation[0].language = #ru
...
* #X.c.6 "Gonadal aralash turdagi yomon sifatli o‘smalar"
  * ^designation[0].language = #ru
...
* #X.c.7 "Gonadal yomon sifatli gonadoblastoma"
  * ^designation[0].language = #ru
...
* #X.e "Boshqa va aniqlanmagan gonadal yomon sifatli o‘smalar"
  * ^designation[0].language = #ru
...
* #XI.a "Adrenokortikal karsinomalar"
  * ^designation[0].language = #ru
...
* #XI.b "Qalqonsimon bez karsinomasi"
  * ^designation[0].language = #ru
...
* #XI.c "Nazofaringeal karsinomalar"
  * ^designation[0].language = #ru
...
* #XI.d "Yomon sifatli melanomalar"
  * ^designation[0].language = #ru
...
* #XI.f "Boshqa va aniqlanmagan karsinomalar"
  * ^designation[0].language = #ru
...
* #XI.f.1 "So‘lak bezlari karsinomasi"
  * ^designation[0].language = #ru
...
* #XI.f.2 "Yo‘g‘on va to‘g‘ri ichak karsinomasi"
  * ^designation[0].language = #ru
...
* #XI.f.6 "Ko'krak bezi karsinomasi"
  * ^designation[0].language = #ru
...
* #XI.f.7 "Bachadon bo'yni karsinomasi"
  * ^designation[0].language = #ru
...
* #XI.f.8 "Siydik pufagi karsinomasi"
  * ^designation[0].language = #ru
...
* #XI.f.10 "Boshqa aniqlangan joylashuvdagi karsinomalar"
  * ^designation[0].language = #ru
...
* #XI.f.11 "Aniqlanmagan joylashuvdagi karsinomalar"
  * ^designation[0].language = #ru
...
* #XII.a "Boshqa aniqlangan yomon sifatli o'smalar"
  * ^designation[0].language = #ru
...
* #XII.a.1 "Gastrointestinal stromal o'sma"
  * ^designation[0].language = #ru
...
* #XII.a.3 "O‘pka blastomasi va plevropulmonal blastoma"
  * ^designation[0].language = #ru
...
* #XII.a.4 "Boshqa murakkab aralash va stromal o‘smalar"
  * ^designation[0].language = #ru
...
* #XII.a.6 "Boshqa aniqlangan yomon sifatli o'smalar"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Другие уточнённые злокачественные опухоли"
  * ^designation[+].language = #en
  * ^designation[=].value = "Other specified malignant tumors"
...
* #XII.b "Boshqa aniqlanmagan yomon sifatli o'smalar"
  * ^designation[0].language = #ru
