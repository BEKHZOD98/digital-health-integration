ValueSet: ScreeningTransformationZoneVS
Id: screening-transformation-zone-vs
...
* ^url = "https://terminology.dhp.uz/fhir/integrations/ValueSet/screening-transformation-zone-vs"
* ^experimental = true
