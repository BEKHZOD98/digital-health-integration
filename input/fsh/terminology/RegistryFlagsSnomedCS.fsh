CodeSystem: RegistryFlagsSnomedCS
Id: registry-flags-snomed-cs
Title: "Registry Flags SNOMED CodeSystem"
Description: "SNOMED CT supplement containing Uzbek and Russian designations for registry flag concepts used in Uzbekistan."

* insert SupplementCodeSystemDraft(
    registry-flags-snomed-cs,
    $sct,
    2026.1.0
)
